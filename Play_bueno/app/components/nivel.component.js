...
var NivelComponent = (function () {
    function NivelComponent(heroeService, auth) {
    ...
    NivelComponent.prototype.delay = function (ms) {
    ...
    NivelComponent.prototype.getPalabras = function () {
        ...
        this.heroeService.getPalabrasHttp()
            ...
            console.log(_this.palabras[0].palabra);
        });
    };
...
NivelComponent = __decorate([
    ...
    __metadata("design:paramtypes", [heroe_service_1.HeroeService, autorizacion_service_1.AuthService])
], NivelComponent);
